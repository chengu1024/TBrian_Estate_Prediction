...
train_tb_index <- createDataPartition(train_tb$town, p = .8, 
                                  ...
                                  times = 1)
train_tb %>% 
  select(total_price, parking_price, txn_floor, city_name, district_name, village_income_median,
         ...
         building_complete_dt_year_original, building_complete_dt_month_original, house_age_original) -> train_tb_select
